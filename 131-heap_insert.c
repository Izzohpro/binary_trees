 ...
 * @tree: pointer to the root node of the tree to check
 * Return: 1 if tree is perfect, 0 it is not
 */
...
/**
 * swap - function that swaps nodes when child is greater than parent
...
/**
 * heap_insert - function to check if a binary tree is a valid Max Binary Heap
